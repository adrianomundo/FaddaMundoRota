...
Violations includes (but are not limited to) parking where it is forbidden (outside parking lanes, on pedestrian crossings, on sidewalks, exc). \\ \\
	...
	\subsection{Assumptions, dependencies and constraints}
		...
		\begin{itemize}
		 ...
		 \item {\bf [D12]} Violation data are collected in order to be analysed.  
		 \end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%				
	\begin{longtable}{| p{3 cm} | p{10.5 cm} |} 
			...
			{\bf ID} & UC9 \\
			\hline
			{\bf Description} & A {\it Authority} accesses to {\it statistics} and {\it ticket statistics}.\\
			\hline
			{\bf Actors} & {\it Logged-in Authority}\\
			\hline
			{\bf Preconditions} & 	
			...
			\begin{enumerate}
				...
				\item The {\it System} shows all the possible details about the selected {\it statistic} or {\it ticket statistics}. 
			\end{enumerate}
			\\
			\hline
			{\bf Postconditions} & 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%				
	...
	\begin{longtable}{| p{3 cm} | p{10.5cm} |} 
			...
			{\bf ID} & UC10 \\
			\hline
			{\bf Description} & The {\it Authority} accesses suggestions on possible interventions \\
			\hline
			{\bf Actors} & {\it Authority}\\
			\hline
			{\bf Preconditions} & 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%			
	...
	The first sequence diagram models the interaction for the creation of a new account. The actors are a {\it Guest} and the {\it System}.
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.55]{Images/Diagrams/sd_signup.png}
	...
	The second sequence diagram models the interaction for the log-in to the application. We created a single sequence diagram for both {\it User} and {\it Authority} because the procedure is almost the same.
		...
		\end{figure}
		The forth sequence diagram models the access and interaction from the user to the application Map. We created a single sequence diagram for both {\it User} and {\it Authority} because the procedure is almost the same.
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.55]{Images/Diagrams/57SeqDiagram.png}
			\caption{Map access sequence diagram}
		\end{figure}
		The fifth sequence diagram models the access and interaction from the user to the application statistics. We created a single sequence diagram for both {\it User} and {\it Authority} because the procedure is almost the same.
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.55]{Images/Diagrams/68SeqDiagram.png}
			\caption{Statistic access sequence diagram}
		\end{figure}
		The sixth sequence diagram models process of ticket generation using data from notifications. 		The actors are the {\it Authority} and the {\it System}.
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.55]{Images/Diagrams/UC7.png}
			\caption{Ticket generation sequence diagram}
		\end{figure}
		The seventh sequence diagram models the interaction occurring when the {\it System} provides suggestions on possible intervention to the {\it Authority}.
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.55]{Images/Diagrams/UC10.png}
			\caption{Intervention suggestions sequence diagram}
		\end{figure}
	...
	\begin{itemize}
			 ...
			 \item {\bf [R15]} The {\it System} must be able to store all the notification data.
			 \item {\bf [D3]} A violation should be clearly visible and identifiable from the picture.
			 \item {\bf [D6]} GPS system of the device has an accuracy of 50 meters.
			 \item {\bf [D7]} Permission to access GPS and device data is granted to the System.
   			 \item {\bf [D8]} Each car has a license plate.
