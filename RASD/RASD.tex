...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%			
	...
	The second sequence diagram models the interaction for the log-in to the application. We created a single sequence diagram for both {\it User} and {\it Authority} because the procedure is almost the same.
		...
		\end{figure}
		The sixth sequence diagram models the access and interaction from the user to the application statistics. We created a single sequence diagram for both {\it User} and {\it Authority} because the procedure is almost the same.
		\begin{figure}[H]
			\centering
